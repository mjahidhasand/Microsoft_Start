...
import ReactionPack from "./ReactionPack";

const Reaction = ({ reaction }: ReactionProps) => {
  const { like, love, surprised, thinking, sad, angry } = reaction;
  const [count, setCount] = useState(
    like + love + surprised + thinking + sad + angry
  );
  const maxReact = Object.entries(reaction)
    .sort((a, b) => b[1] - a[1])
    .slice(0, 3)
        ...
        {count === 0 ? (
          <>
            <svg width="20" height="20" viewBox="0 0 20 20">
              ...
              <path
                fill="currentColor"
                d="M6.15467 11.4273C7.02454 12.3027 8.19797 12.6929 9.33847 12.5969C9.33008 12.6191 9.32188 12.6415 9.31387 12.6641C9.20621 12.9682 9.12455 13.2846 9.07154 13.6106C7.76002 13.6292 6.44289 13.136 5.44533 12.1322C5.25069 11.9363 5.25169 11.6197 5.44757 11.4251C5.64344 11.2304 5.96002 11.2314 6.15467 11.4273Z"
              ></path>
              <path
                fill="currentColor"
                d="M11.5 6.5C12.0523 6.5 12.5 6.94772 12.5 7.5C12.5 8.05228 12.0523 8.5 11.5 8.5C10.9477 8.5 10.5 8.05228 10.5 7.5C10.5 6.94772 10.9477 6.5 11.5 6.5Z"
              ></path>
              <path
                fill="currentColor"
                d="M6.5 6.5C7.05228 6.5 7.5 6.94772 7.5 7.5C7.5 8.05228 7.05228 8.5 6.5 8.5C5.94772 8.5 5.5 8.05228 5.5 7.5C5.5 6.94772 5.94772 6.5 6.5 6.5Z"
              ></path>
              <path
                fill="currentColor"
